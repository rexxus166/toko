...
<div id="main-content" class="min-h-screen">
    ...
    <div class="bg-white shadow-md py-4 px-6 flex justify-between items-center">
        ...
        <h2 class="font-poppins text-xl font-semibold">Edit Supplier</h2>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.supplier.update', $supplier->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ $supplier->name }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter supplier name" required>
                </div>
